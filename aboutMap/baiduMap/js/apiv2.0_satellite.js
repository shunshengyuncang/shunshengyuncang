window.BMAP_AUTHENTIC_KEY = "G8WFHhzBgO3OoXmklyUuZqAlDl45wtLe"; (function() {
    var aa = void 0,
    i = !0,
    n = null,
    o = !1;
    ...
    nc.getTilesUrl = function(a, b) {
        ...
        return url = this.BB[Math.abs(c + d) % this.BB.length] + this.map.Fb + "/" + this.map.Fs + "/3/lv" + (21 - b) + "/" + c + "," + d + ".png"
    };
    var ta = new hc("\u4e09\u7ef4", nc, {
        tips: "\u663e\u793a\u4e09\u7ef4\u5730\u56fe",
        minZoom: 15,
