/**
  ...
  * blogCarousellist 博客Carousellist

  * googleMap 谷歌地图

  * FlatFlexTestimonial 平Flex证明

  * flatTestimonials 平的奖状
   ...
   'use strict'
    ...
    var retinaLogos = function() {
      var retina = window.devicePixelRatio > 1 ? true : false;
        if(retina) {
            $('.header .logo').find('img').attr({src:'./icon/logo1-80.png',width:'80',height:'46'});   
        }

        if(retina) {
            $('.footer .logo').find('img').attr({src:'./icon/logo1-80.png',width:'80',height:'46'});   
        }
    };    
